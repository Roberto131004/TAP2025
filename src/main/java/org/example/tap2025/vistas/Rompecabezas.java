...
public class Rompecabezas extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Juego de Rompecabezas");

        // Selector de tamaño del rompecabezas
        ...
        // Configuración del tablero del rompecabezas
    ...
    private void startGame() {
        ...
        for (int row = 0; row < gridSize; row++) {
            for (int col = 0; col < gridSize; col++) {
                ...
                PuzzlePiece piece = new PuzzlePiece(imagePath, row, col, this);
                tempTiles.add(piece);
            }
        }
